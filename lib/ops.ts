...
export type ShareAllocation={id:string;userId:string;userName:string;symbol:string;name:string;requestedAmount:number;shares:number;price:number;value:number;status:'Pending'|'Approved'|'Rejected';createdAt:string}
export type AccountAdjustment={id:string;userId:string;userName:string;amount:number;kind:'Credit'|'Debit'|'Scheduled daily gain';note:string;createdAt:string}
...
export const initialShareControls:ShareControl[]=[
 {symbol:'AAPL',name:'Apple',enabled:true,manualPrice:231.42,previousPrice:229.80,marketCap:3500000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:250,approvalRequired:true},
 {symbol:'MSFT',name:'Microsoft',enabled:true,manualPrice:512.18,previousPrice:508.21,marketCap:3800000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:200,approvalRequired:true},
 {symbol:'NVDA',name:'NVIDIA',enabled:true,manualPrice:179.63,previousPrice:176.88,marketCap:4380000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:300,approvalRequired:true},
 {symbol:'GOOGL',name:'Alphabet',enabled:true,manualPrice:201.14,previousPrice:199.20,marketCap:2460000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:300,approvalRequired:true},
 {symbol:'AMZN',name:'Amazon',enabled:true,manualPrice:231.30,previousPrice:228.42,marketCap:2450000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:300,approvalRequired:true},
 {symbol:'META',name:'Meta Platforms',enabled:true,manualPrice:747.62,previousPrice:738.10,marketCap:1880000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:150,approvalRequired:true},
 {symbol:'TSLA',name:'Tesla',enabled:true,manualPrice:338.72,previousPrice:331.15,marketCap:1090000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:250,approvalRequired:true},
 {symbol:'AVGO',name:'Broadcom',enabled:true,manualPrice:306.48,previousPrice:301.92,marketCap:1440000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:250,approvalRequired:true},
 {symbol:'JPM',name:'JPMorgan Chase',enabled:true,manualPrice:295.31,previousPrice:292.20,marketCap:812000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:250,approvalRequired:true},
 {symbol:'V',name:'Visa',enabled:true,manualPrice:352.84,previousPrice:350.25,marketCap:687000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:250,approvalRequired:true},
 {symbol:'MA',name:'Mastercard',enabled:true,manualPrice:589.40,previousPrice:584.60,marketCap:535000000000,allocationCapPct:25,minAmount:100,maxAmount:50000,maxShares:200,approvalRequired:true},
 {symbol:'NFLX',name:'Netflix',enabled:true,manualPrice:1240.20,previousPrice:1228.10,marketCap:528000000000,allocationCapPct:20,minAmount:100,maxAmount:50000,maxShares:100,approvalRequired:true},
